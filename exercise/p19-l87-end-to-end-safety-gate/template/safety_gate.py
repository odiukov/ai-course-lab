...
class SafetyGate:
    ...
    def handle(self, prompt: str) -> RequestTrace:
        """Собери полный жизненный цикл запроса: pre-gen с ранней блокировкой, потоковую проверку, допустимый post-gen, агрегацию, применение действия и заполнение трассы с задержкой."""
        raise NotImplementedError


def trace_to_dict(t: RequestTrace) -> dict[str, object]:
    """Преобразуй RequestTrace и вложенные вердикты в JSON-совместимый словарь, сохранив отсутствие post-gen для ранних блокировок."""
    raise NotImplementedError
