...
def has_non_finite_grad(parameters: Iterable[torch.nn.Parameter]) -> bool:
    """Проверьте все существующие градиенты параметров и сообщите, содержит ли хотя бы один из них NaN или Inf."""
    raise NotImplementedError


def compute_global_l2_norm(parameters: Iterable[torch.nn.Parameter]) -> float:
    """Вычислите общую L2-норму всех существующих градиентов параметров, игнорируя параметры с grad=None."""
    raise NotImplementedError
...
def clip_global_l2_norm(
    ...
    """Обрежьте градиенты на месте по глобальной L2-норме и верните нормы до и после обрезки, проверяя допустимость max_norm."""
    raise NotImplementedError
...
class AmpTrainState:
    ...
    def step(
        ...
        """Реализуйте безопасный AMP-шаг обучения: autocast, проверку loss, масштабированный backward, unscale, проверку градиентов, clipping, шаг оптимизатора, обновление scaler и журналирование пропусков."""
        raise NotImplementedError
