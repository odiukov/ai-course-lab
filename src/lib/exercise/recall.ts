 ...
 * упражнения, в упражнении нет файла `fileName` (у одно-файловой формы это
 * всегда `exercise.py`, у каталожной — `main.py` и соседи) или в этом файле
 * нет функции `fn`. «Замена не изменила
