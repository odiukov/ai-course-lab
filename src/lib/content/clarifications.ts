...
//
// .trim() здесь осознанный, а не забытый: вопрос приходит из поля ввода
// чата, и обрезка пробелов/переносов по краям — это нормализация ввода, а
// не потеря данных. Внутренние пробелы и переносы строк экранируются и
// переживают круг без потерь; граничные — нет, и не должны.
